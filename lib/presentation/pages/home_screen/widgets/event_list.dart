                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        currentDayTask[index]!.name,
                        style: TextStyle(
                            fontSize: 14.sp,
                            fontWeight: FontWeight.w600,
                            color: Color(currentDayTask[index]!.color)),
                      ),
                      currentDayTask[index]!.description.isEmpty
                          ? const SizedBox()
                          : Text(
                      ...
                      Row(
                        children: [
                          currentDayTask[index]!.firstDate.isEmpty
                              ? const SizedBox()
                              : SvgPicture.asset(
                                  AppIcons.timeIcon,
                          ...
                          Text(
                            '${currentDayTask[index]!.firstDate} - ${currentDayTask[index]!.secondDate}',
                            style: TextStyle(
                                fontSize: 10.sp,
                          ...
                          currentDayTask[index]!.location.isEmpty
                              ? const SizedBox()
                              : SvgPicture.asset(
